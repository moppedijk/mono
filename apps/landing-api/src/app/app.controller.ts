...
export class AppController {
  ...
  async postContact(
    ...
    const isEmailValid = this.validatorService.validateEmail(request.body['email']);
    const isNameValid = this.validatorService.validateName(request.body['name']);
    const isMessageValid = this.validatorService.validateMessage(request.body['message']);
    ...
    await this.emailService.emailContact({
